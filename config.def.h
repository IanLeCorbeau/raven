...
const unsigned int gappx	= 8;	/* gaps between windows */
const unsigned int snap		= 32;	/* snap pixel */
const unsigned int barpadding	= 24;	/* Bar padding in pixel */
...
const struct Rule rules[] = {
	...
	{ "Firefox",  NULL,       NULL,       1 << 2,       0,           -1 },	/* Some distributions require firefox without a capital "f" */
};
...
const struct Layout layouts[] = {
	...
	{ "TTT",	bstack },	/* Master at top, stack at bottom */
	{ "[]",		monocle },
